 ...
 * {@code PreparedStatement.setShort} transfer data. If the field maps to a date
 * column date-to-short and short-to-date conversion is done using the "yyyy"
 * format.
 */
	...
	public static Date shortToDate(short s) throws ParseException
	{
		...
		if (shortString.length() != 4) {
			throw new BindException(
					"Too many digits in value. Maximum is 4. Shorts are converted to Dates using \"yyyy\" format.");
		}
