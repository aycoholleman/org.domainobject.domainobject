...
public final class DoubleBinder extends NumberBinder {
	...
	// public void send(Object instance, MetaData metadata, Field field,
	...
	@Override
	public void send(Object val, Column column, PreparedStatement ps, int parameterIndex)
			throws SQLException
	{
		ps.setDouble(parameterIndex, ((Double) val).doubleValue());
	}

	// public void receive(Object instance, MetaData metadata, Field field,
	// ResultSet rs,
